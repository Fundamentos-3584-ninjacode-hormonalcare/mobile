...
class PatientsListService {
  final String baseUrl = 'https://hormonal-care-backend-production.up.railway.app/api/v1/medical-record/patient';
  final String profileBaseUrl = 'https://hormonal-care-backend-production.up.railway.app/api/v1/profile/profile';
  final String doctorBaseUrl = 'https://hormonal-care-backend-production.up.railway.app/api/v1/doctor/doctor';
